...
class _busArrivedScreenState extends State<busArrivedScreen> {
  ...
  //updated bus_arrived_screen to use timer to periodically check for bus arrival at the next stop, previously used while loop + sleep(20)
  //usingg timer, the timer can be stopped when the overlay is removed
  @override
