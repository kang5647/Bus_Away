...
class _busArrivedScreenState extends State<busArrivedScreen> {
  ...
  late String boardingStopName;
  late String alightingStopName;
  ...
  void initState() {
    ...
    setState(() {
      ...
      alightingStopName = widget
          .arrivalManager.bus.busStopName[widget.arrivalManager.destIndex];
    });
    Future.delayed(
              ...
              child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('${boardingStopName} - ${alightingStopName}',
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 20,
